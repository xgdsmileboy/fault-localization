...
public class Instrument extends AbstractHandler {
	...
	private boolean insertCode(CompilationUnit compilationUnit) {
		compilationUnit.accept(new InstrumentVisitor());
		return true;
	}

}

class InstrumentVisitor extends ASTVisitor {
	...
	private List<Statement> process(Statement statement, String message) {
		...
		if (statement instanceof IfStatement) {
			...
			if (statement instanceof ExpressionStatement || statement instanceof SuperConstructorInvocation
					|| statement instanceof ConstructorInvocation || statement instanceof AssertStatement
